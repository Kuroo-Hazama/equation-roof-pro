      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm font-body">
            <a href="https://share.google/gzbbMMOG3ENd5qnbt" target="_top" rel="noopener" className="flex items-start gap-2 text-primary-foreground/80 hover:text-primary transition-colors">
