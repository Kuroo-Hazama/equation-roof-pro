...
const expertises = [
  ...
  },
  {
    id: "quartz",
    icon: Gem,
    title: "Revêtement Quartz — Esthétique et Performance",
    img: ipeImg,
  ...
  },
  {
    id: "dalles",
    icon: Grid3X3,
    title: "Dalles sur Plots — Aménagez Votre Toiture Terrasse",
    img: ipeImg,
  ...
  },
  {
    id: "vegetalisee",
    icon: Leaf,
    title: "Toiture Végétalisée — Performance Écologique",
    img: greenRoofImg,
        ...
        <ScrollReveal key={e.id}>
          <section id={e.id} className={`grid md:grid-cols-2 gap-12 items-center ${i % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
            ...
            <div className={i % 2 === 1 ? "md:order-1" : ""}>
              ...
              <Link to="/contact" className="btn-gold inline-block mt-6 text-sm">
